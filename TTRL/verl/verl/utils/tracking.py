...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, group_name = "", run_id = "", default_backend: Union[str, List[str]] = "console", config=None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            if run_id == "":
                wandb.init(project=project_name, name=experiment_name, config=config, group=group_name)
            else:
                wandb.init(project=project_name, name=experiment_name, config=config, group=group_name, id=run_id)
